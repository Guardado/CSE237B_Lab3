...
func main() {
	//var start C.struct_timespec
	//var end C.struct_timespec
	...
	*/
	...
	for {
		...
		C.ACC_getADC ();
  		fmt.Printf("Accel X: %d \n", C.imu.accADC[C.ROLL]);
  		fmt.Printf(" Y: %d \n", C.imu.accADC[C.PITCH]);        
  		fmt.Printf(" Z: %d \n", C.imu.accADC[C.YAW]); 
  		C.Gyro_getADC();
  		fmt.Printf("\t Gyro X: %d \n", C.imu.gyroADC[C.PITCH]);
  		fmt.Printf(" Y: %d \n", C.imu.gyroADC[C.ROLL]);
  		fmt.Printf(" Z: %d \n", C.imu.gyroADC[C.YAW]);
  		C.Device_Mag_getADC();
  		fmt.Printf("\t Mag X: %d \n ", C.imu.magADC[C.ROLL]);  
  		fmt.Printf(" Y: %d \n", C.imu.magADC[C.PITCH]);    
  		fmt.Printf(" Z: %d \n", C.imu.magADC[C.YAW]);
